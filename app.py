...
st.write(
    "To know more about this app, visit [**GitHub**](https://github.com/r-narula/Food-Vision)")
...
try:
    ...
    st.warning(
        "Please create a **Issue** on [Github](https://github.com/r-narula/Food-Vision)")


st.markdown("Created by **Raghav Narula**")
st.markdown(body="""

<th style="border:None"><a href="https://www.linkedin.com/in/r-narula2001/" target="blank"><img align="center" src="https://bit.ly/3wCl82U" alt="Linkedin" height="40" width="40" /></a></th>
<th style="border:None"><a href="https://github.com/r-narula" target="blank"><img align="center" src="https://bit.ly/3c2onZS" alt="Git" height="40" width="40" /></a></th>
